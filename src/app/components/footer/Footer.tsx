...
//                   {[...Array(4)].map((_, idx) => (
//                     <article key={idx} className="group hover:bg-[#0650C3] transition-all duration-200 p-[10px] cursor-pointer bg-[#0650C3]/[18%] rounded-lg">
//                       <Image src={lnkdn} alt="Ijtimoiy tarmoq logo" width={20} height={20} />
//                     </article>
//                   ))}
//                 </div>
//               </div>
