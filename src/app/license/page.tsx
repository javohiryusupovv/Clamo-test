...
const Page = () => {
  const steps: {
    ...
    title: string;
    description: string;
    icon: "form" | "check" | "review" | "decision";
  }[] = [
    {
      id: 1,
    ...
    <>
      <div className="relative">
        ...
        <div className="container mx-auto px-4">
          <div className="w-full min-h-screen flex flex-col md:flex-row items-center justify-between gap-6 relative z-10 py-12 md:py-0">
            {/* Chap taraf: matn */}
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <article className="space-y-6 w-full md:w-[45%] mx-auto md:mx-0">
                ...
                <p className="text-[#012548CC] leading-[140%] text-[18px] sm:text-[20px] font-medium max-w-xl mx-auto md:mx-0">
              ...
              <article className="flex flex-col sm:flex-row items-center gap-3 pt-8 justify-center md:justify-start">
                ...
                <button className="group flex justify-center items-center gap-[4px] w-full sm:w-[273px] px-[24px] py-[10px] bg-[#23B3FC1F] text-[#23B3FC] rounded-lg hover:bg-[#23B3FC] hover:text-white transition">
            ...
            {/* O‘ng taraf: rasm */}
            <div className="hidden md:flex md:flex-1 justify-center items-center w-full sm:w-[80%] md:w-[55%] h-auto mt-8 md:mt-0 md:absolute z-[-10] md:right-[-50px] sm:static">
              <Image
                src="/Bg.png"
                alt="Illyustratsiya"
                width={694}
                height={684}
                priority
                className="w-full sm:w-[80%] md:w-full h-[300px] sm:h-[500px] md:h-[684px] object-contain"
              />
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4">
        <section className="bg-gradient-to-b from-[#39a9f2] to-[#0653C9] text-white rounded-3xl p-6 md:p-10 max-w-6xl mx-auto my-10">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Chap blok */}
            <div className="flex flex-col gap-4 w-full">
              <h2 className="text-3xl md:text-5xl font-bold mb-4 w-full sm:w-[80%]">
                Litsenziya olish bosqichlari
              </h2>

              <p className="text-base md:text-[20px] leading-[150%] mb-6 w-full sm:w-[72%]">
