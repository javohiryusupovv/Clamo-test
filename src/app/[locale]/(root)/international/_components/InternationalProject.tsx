  ...
  return (
    <div className="w-full md:py-16">
      <div className="container">
        <h3 className="text-center font-bold text-3xl font-vk md:text-5xl text-[#3D445E] mb-[20px] md:mb-[71px]">
          {t("hamkorlarr")}
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:gap-20 gap-14 max-md:pt-8 md:gap-10">
          {hamkorlar.map((item, index) => (
            ...
            >
              ...
              <h6 className="text-xl md:text-2xl font-bold font-vk leading-[150%] text-white mb-3 md:mb-4">
                {item.title}
              </h6>
              <p className="text-[14px] font-vk font-normal text-white leading-[150%] text-center">
                {item.desc}
              </p>
            </div>
          ))}
