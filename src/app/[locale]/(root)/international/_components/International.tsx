      ...
      <div className="container pt-3 relative top-0 left-0 flex flex-col md:flex-row gap-10 md:gap-[65px] justify-between items-center w-full md:mb-12">
        <article className="w-full md:w-[45%] relative z-[10]">
          ...
          <article className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <button className="group font-inter lg:px-[85px] px-5 h-[40px] flex items-center justify-center gap-[11.5px] hover:bg-[hsl(200,97%,65%)] bg-[#23b3fc] transition-all duration-200 rounded-lg text-sm font-medium text-white leading-[130%] ">                    
                {t("hamkorlar_btn")}{" "}
              <ChevronRight className="w-5 h-5 md:group-hover:translate-x-2 transition-all duration-200" />
            </button>
            <button className="group font-inter flex items-center justify-center gap-1 bg-[#23B3FC]/[12%] text-[#23B3FC] w-full sm:w-[272px] h-10 rounded-lg cursor-pointer text-[14px] font-medium transition-all duration-200 hover:bg-[#23B3FC]/[30%]">
              {t("hamkorlar_btn2")}{" "}
              <ChevronRight className="w-5 h-5 md:group-hover:translate-x-2 transition-all duration-200" />
            </button>
          </article>
