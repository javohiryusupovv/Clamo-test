...
export default function AboutMain() {
  ...
  return (
    <div className="relative w-full overflow-visible max-sm:flex max-sm:items-start max-sm:pt-10 max-sm:h-[80vh] h-screen pb-8 lg:pb-32">
      ...
      <div className="absolute block z-0 transition-all duration-700 ease-in-out bottom-0 max-sm:right-[-90px] lg:top-0 lg:right-0 lg:w-[55%] lg:h-full md:bottom-[150px] md:right-[-30px] max-sm:scale-90 sm:bottom-[-66px] sm:top-auto sm:w-[729px] sm:h-[486px] max-sm:w-[350px] max-sm:h-[370px]">
