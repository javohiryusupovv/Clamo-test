  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow border space-y-3 mb-[24px]">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start flex-wrap sm:flex-nowrap gap-2">
        ...
        <Link href={"https://cabinet.clamo.uz/"} target="_blank" className="group font-inter flex items-center justify-center gap-1 mt-2 sm:mt-0 text-[10px] sm:text-xs md:text-sm text-[#23B3FC] font-medium bg-blue-50 px-1.5 sm:px-2 md:px-3 py-1.5 sm:py-2 rounded-md hover:bg-blue-100 transition-colors">
          {t("view_license")}
