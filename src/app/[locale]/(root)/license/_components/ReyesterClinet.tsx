  ...
  return (
    <div>
      <div className="flex items-center justify-end gap-2 sm:gap-4 mb-6">
        ...
        >
          <option value="">{t("all_section")}</option>
          {types.map((type) => (
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2 text-sm text-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      </div>
