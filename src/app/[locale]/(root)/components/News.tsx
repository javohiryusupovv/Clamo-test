  ...
  return (
    <div className="container pb-10">
      ...
      <div className="flex md:justify-end justify-center pt-6">
        <Link href={`/${locale}/news`} aria-label="Learn more about news">
          <button className="group font-inter lg:px-20 px-10 h-[40px] flex items-center justify-center gap-[11.5px] hover:bg-[#23B3FC]/[80%] bg-[#23B3FC] transition-all duration-200 rounded-lg text-sm font-medium text-white leading-[130%] "> 
            {t("learn_more_button")}
