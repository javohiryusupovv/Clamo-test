      ...
      <div className="container relative left-0 z-[40] max-lg:p-4 flex flex-col md:flex-row items-center justify-between w-full bg-[#0653C9] lg:rounded-[36px] rounded-2xl">
        ...
        <div className="w-full lg:w-[450px] md:pl-6 md:pr-6 py-10 lg:pl-14 lg:py-14">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              {/* Phone */}
              <div
                  className="group hover:bg-[white]/[8%] transition-all duration-200 border border-opacity-[16%] items-center border-white gap-2 inline-flex items-start py-3 px-4 rounded-2xl"
              >
        ...
        <div className="py-6 px-4 sm:px-8 lg:mt-0 border border-gray-200 w-full sm:w-[500px] lg:absolute lg:right-16 h-auto bg-white lg:rounded-[36px] rounded-2xl">
          <article className="mb-[26px]">
            <h2 className="text-[24px] sm:text-[28px] font-vk lg:text-[32px] font-bold leading-[120%] text-[#3D445E] mb-3">
              {t('formTitle')}
            </h2>
