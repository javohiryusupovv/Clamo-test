  ...
  return (
    <>
      ...
      <section className="container grid lg:grid-cols-2 grid-cols-1 lg:gap-20 lg:pb-10 relative sm:top-0 md:top-10 lg:top-0 left-0 h-[70vh] overflow-visible">
        ...
        <div className="flex flex-col justify-end items-center w-auto relative max-ms:-bottom-20 max-lg:bottom-[20px] right-0 max-lg:translate-y-[60px] lg:translate-y-[70px] xl:translate-y-10">
          <img
