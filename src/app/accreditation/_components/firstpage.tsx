  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex-1">
        <div className="max-w-full lg:max-w-[557px] relative z-10 flex flex-col gap-[16px] pt-[40px] sm:pt-[50px] md:pt-[60px] lg:pt-[176px] px-1">
          ...
          <div className="mt-[10px] md:mt-[30px] lg:mt-[40px] flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <button className="bg-[#23B3FC] w-full sm:w-[200px] md:w-[240px] lg:w-[272px] py-[10px] gap-[5px] border-0 rounded-lg justify-center flex items-center text-[#FFFFFF] text-[14px] leading-[1.3] font-medium">
              Xizmatlarimiz <ChevronRight size={22} />
            </button>
            <button className="bg-[#23B3FC1F] w-full sm:w-[200px] md:w-[240px] lg:w-[272px] py-[10px] gap-[5px] border-0 rounded-lg justify-center flex items-center text-[#23B3FC] text-[14px] leading-[1.3] font-medium">
              Murojaat qilish <ChevronRight size={22} />
            </button>
          </div>
        </div>
      ...
      {/* Bottom Gradient */}
      <div className="absolute bottom-0 left-0 w-full h-[120px] md:h-[180px] lg:h-[440px] bg-gradient-to-t from-white/100 to-transparent"></div>
    </div>
  );
}
