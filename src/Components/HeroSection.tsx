  ...
  return (
    <div className="bg-[#F6F9FC] h-[480px] pt-[50px]">
      <div className="container w-full h-[310px] relative">
        ...
        <div className="absolute top-[270px] w-[1008px] h-[130px] mb-[40px] flex items-center justify-center z-[20] bg-white rounded-lg left-1/2 transform -translate-x-1/2">
